...
SECRET_KEY = "django-insecure-tk)ysei3(z#2+!l*8jr6$wlp74r9g&2zog&^pt&inpm*625!u+"
...
MIDDLEWARE = [
    ...
    "marketplace.middleware.CustomResponseMiddleware",
    "marketplace.middleware.CustomErrorHandlerMiddleware",
]
